    ...
    async run({ message }) {
        ...
        if (!data || !data.pendingproposal) {
            return message?.reply(
                "<:nobody_cares:1066336605926862928> You don't have any pending proposals."
            );
        }
        ...
        return message?.reply(
            `<a:snc_congo:1066331725468270632> Congratulations! You are now married to **${proposer.username}**!`
        );
    }

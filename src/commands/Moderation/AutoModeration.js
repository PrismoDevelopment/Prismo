    ...
    async run({ message, args }) {
        if (!args[0])
            return this.client.util.errorDelete(
                message,
                `You Must Specify A Option! (enable/disable)`
            );
        if (args[0] === "enable") {
            let engwordlist = [
                "*https://*",
                ...
                return message?.channel.send({
                    embeds: [
                        this.client.util
                            ...
                            .setDescription(
                                `${this.client.config.Client.emoji.tick} | AutoMod is already **enabled** in this server!`
                            )
                            .setTimestamp(),
                    ],
                });
            ...
            await message?.channel.send({
                embeds: [
                    this.client.util
                        ...
                        .setColor(this.client.util.color(message))
                        .setDescription(
                            `${this.client.config.Client.emoji.tick} | AutoMod has been **enabled** in this server!`
                        )
                        .setTimestamp(),
                ],
            });
                ...
                return message?.channel.send({
                    embeds: [
                        this.client.util
                            ...
                            .setColor(this.client.util.color(message))
                            .setDescription(
                                `${this.client.config.Client.emoji.tick} | AutoMod is already **disabled** in this server!`
                            )
                            .setTimestamp(),
                    ],
                });
            ...
            await message?.channel.send({
                embeds: [
                    this.client.util
                        ...
                        .setColor(this.client.util.color(message))
                        .setDescription(
                            `${this.client.config.Client.emoji.tick} | AutoMod has been **disabled** in this server!`
                        )
                        .setTimestamp(),
                ],
            });

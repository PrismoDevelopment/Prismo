...
module.exports = class Blacklistchannel extends Command {
    ...
    async run({ message, args }) {
        ...
        if (args[0] === "channel") {
            ...
            if (args[1] === "clear") {
                ...
                return message?.reply({
                    embeds: [
                        this.client.util.doDeletesend(message, "I have cleared the blacklist."),
                    ],
                });
            }
            if (args[1] === "add") {
                ...
                if (!channel)
                    return message?.reply({
                        embeds: [
                            this.client.util.errorDelete(message, "I couldn't find that channel."),
                        ],
                    });
                if (data.disabledChannels.includes(channel.id)) {
                    ...
                    return message?.reply({
                        embeds: [
                            this.client.util.doDeletesend(
                                message,
                                `I have removed ${channel} from the blacklist.`
                            ),
                        ],
                    });
                } else {
                    ...
                    return message?.reply({
                        embeds: [
                            this.client.util.doDeletesend(
                                message,
                                `I have added ${channel} to the blacklist.`
                            ),
                        ],
                    });
                }
                ...
                if (data.disabledChannels.includes(channel.id)) {
                    ...
                    return message?.reply({
                        embeds: [
                            this.client.util.errorDelete(
                                message,
                                "That channel isn't on the blacklist."
                            ),
                        ],
                    });
                }
                ...
                if (!list)
                    return message?.reply({
                        embeds: [
                            this.client.util.errorDelete(
                                message,
                                "There are no blacklisted commands."
                            ),
                        ],
                    });
                let embed = this.client.util
                ...
                if (!command)
                    return message?.reply({
                        embeds: [
                            this.client.util.errorDelete(
                                message,
                                "Please specify a command to blacklist."
                            ),
                        ],
                    });
                if (data.disabledCommands.includes(command)) {
                    ...
                    return message?.reply({
                        embeds: [
                            this.client.util.doDeletesend(
                                message,
                                `I have removed \`${command}\` from the blacklist.`
                            ),
                        ],
                    });
                } else {
                    ...
                    return message?.reply({
                        embeds: [
                            this.client.util.doDeletesend(
                                message,
                                `I have added \`${command}\` to the blacklist.`
                            ),
                        ],
                    });
                }
                ...
                if (data.disabledCommands.includes(command)) {
                    ...
                    return message?.reply({
                        embeds: [
                            this.client.util.errorDelete(
                                message,
                                "That command isn't on the blacklist."
                            ),
                        ],
                    });
                }
    ...
    async exec({ interaction }) {
        let data = await this.client.database.guildData.get(interaction?.guild.id);
        ...
        if (subcommand === "channel") {
            ...
            if (action === "add") {
                ...
                if (!channel)
                    return interaction?.reply({
                        content: "please specify a channel to blacklist.",
                        ephemeral: true,
                    });
                if (data.disabledChannels.includes(channel.id)) {
                    data.disabledChannels = data.disabledChannels.filter((c) => c !== channel.id);
            ...
            if (action === "remove") {
                ...
                if (data.disabledChannels.includes(channel.id)) {
                    ...
                    return interaction?.reply({
                        content: "That channel isn't blacklisted.",
                        ephemeral: true,
                    });
                }
            }
        ...
        if (subcommand === "command") {
            ...
            if (action === "add") {
                ...
                if (!command)
                    return interaction?.reply({
                        content: "Please specify a command to blacklist.",
                        ephemeral: true,
                    });
                if (data.disabledCommands.includes(command)) {
                    data.disabledCommands = data.disabledCommands.filter((c) => c !== command);
            ...
            if (action === "remove") {
                ...
                if (data.disabledCommands.includes(command)) {
                    ...
                    return interaction?.reply({
                        content: "That command isn't blacklisted.",
                        ephemeral: true,
                    });
                }
            }

...
module.exports = class Event extends EventEmitter {
    ...
    constructor(client) {
        ...
        if (this.constructor === Event)
            throw new TypeError('Abstract class "MainEvent" cannot be instantiated directly.');
        if (this.name === undefined)
            throw new TypeError('Classes extending MainEvent must have a getter "name"');
        if (this.once === undefined)
            throw new TypeError('Classes extending MainEvent must have a getter "once"');
